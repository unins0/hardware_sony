...
public class TileEntryActivity: Activity() {
    ...
    private val HAPTICS_TILE: String = "com.xperia.settings.haptics.MediaVibrationTileService";
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (sourceClass?.className) {
            HAPTICS_TILE -> {
                ...
                intent.setComponent(
                    ComponentName("com.xperia.settings.haptics",
                        "com.xperia.settings.haptics.MediaVibrationActivity"));
